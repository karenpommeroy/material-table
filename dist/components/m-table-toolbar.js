...
var MTableToolbar = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableToolbar, [{
    ...
    key: "renderTextSearch",
    value: function renderTextSearch() {
      var _this3 = this;
      ...
      if (this.props.textSearch) {
        return /*#__PURE__*/React.createElement(_TextField["default"], {
          ...
          value: this.props.searchText,
          onChange: function onChange(event) {
            return _this3.props.onSearchChanged(event.target.value);
          },
          placeholder: localization.searchPlaceholder,
          variant: this.props.fieldVariant,
          size: this.props.fieldSize,
          InputProps: {
            ...
            endAdornment: /*#__PURE__*/React.createElement(_InputAdornment["default"], {
              ...
              disabled: !this.props.searchText,
              onClick: function onClick() {
                return _this3.props.onSearchChanged("");
              }
            }, /*#__PURE__*/React.createElement(this.props.icons.ResetSearch, {
              color: "inherit",
              fontSize: "small"
    ...
    value: function renderCustomActions() {
      if (this.props.customActions) {
        return /*#__PURE__*/React.createElement("div", null, this.props.customActions.map(function (item) {
          return item();
        }));
      } else {
        return null;
    ...
    value: function renderSelectedActions() {
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(this.props.components.Actions, {
        actions: this.props.actions.filter(function (a) {
          return a.position === "toolbarOnSelect" || a.position === "toolbar";
        }),
    ...
    value: function render() {
      ...
      }, title && this.renderToolbarTitle(title), this.props.searchFieldAlignment === 'left' && this.renderSearch(), this.props.searchFieldAlignment === 'left' && this.renderTextSearch(), this.props.customActionsAlignment === 'left' && this.renderCustomActions(), this.props.toolbarButtonAlignment === 'left' && this.renderActions(), /*#__PURE__*/React.createElement("div", {
        className: classes.spacer
      }), this.props.searchFieldAlignment === 'right' && this.renderSearch(), this.props.searchFieldAlignment === 'right' && this.renderTextSearch(), this.props.customActionsAlignment === 'right' && this.renderCustomActions(), this.props.toolbarButtonAlignment === 'right' && this.renderActions());
    }
  }]);
...
MTableToolbar.propTypes = {
  ...
  textSearch: _propTypes["default"].bool.isRequired,
  fieldVariant: _propTypes["default"].string.isRequired,
  fieldSize: _propTypes["default"].string.isRequired,
  customActions: _propTypes["default"].oneOfType([_propTypes["default"].element, _propTypes["default"].array]),
  ...
  customActionsAlignment: _propTypes["default"].string.isRequired,
